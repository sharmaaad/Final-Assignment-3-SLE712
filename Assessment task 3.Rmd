...
```
## Part 2, Question 1. Downloading the the whole set of E. coli gene DNA sequences and finding how many sequences are present in the E.coli set.
in this part, we download the sequence and software packages which will be used in R to get the code working.
```{r, chunk13, echo=TRUE}
...
# download the provided E. coli CDS from sequences from Github
...
# delete the fasta file if already exists
